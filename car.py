...
with st.sidebar:
    ...
    st.info(
        """
        This application uses a **Random Forest Regressor** model 
        trained on **154,111 vehicles** from the CarDekho dataset to 
...
st.markdown("""
    <div class="info-card">
        ...
        will predict its market value based on 150K+ historical sales data points.
    </div>
""", unsafe_allow_html=True)
...
st.markdown(f"""
    <div style="text-align: center; color: #666; padding: 2rem 0;">
        ...
        <p>Powered by <strong>Random Forest Regressor</strong> | Trained on <strong>CarDekho Dataset</strong></p>
        <p style="font-size: 0.9rem; margin-top: 1rem;">
            <em>This prediction is an estimate based on historical data and should not be considered as a final market price.</em>
        </p>
